...
namespace MDD.Default.Endpoints
{
    [Route("Services/Default/Orders/[action]")]
    ...
    public class OrdersController : ServiceEndpoint
    {
            ...
            [FromServices] IExcelExporter exporter)
        {
            ...
            var bytes = exporter.Export(data, typeof(Columns.OrdersColumns), request.ExportColumns);
            return ExcelContentResult.Create(bytes, "OrdersList_" +
