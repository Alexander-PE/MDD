...
declare namespace MDD.Administration {
...
declare namespace MDD.Membership {
...
declare namespace MDD.Authorization {
...
declare namespace MDD.LanguageList {
    function getValue(): string[][];
}
declare namespace MDD.ScriptInitialization {
}
declare namespace MDD.Common {
...
declare namespace MDD.Default {
    ...
    namespace OrderDetailsRow {
        const idProperty = "Id";
        const nameProperty = "ProductProductName";
        const localTextPrefix = "Default.OrderDetails";
        const deletePermission = "Administration:General";
        const insertPermission = "Administration:General";
        const readPermission = "Administration:General";
        const updatePermission = "Administration:General";
...
declare namespace MDD.Default {
    namespace OrderDetailsService {
        const baseUrl = "Default/OrderDetails";
...
declare namespace MDD.Default {
    ...
    namespace ProductosRow {
        ...
        const localTextPrefix = "Default.Productos";
        const lookupKey = "Default.Productos";
...
declare namespace MDD.Default {
    namespace ProductosService {
        const baseUrl = "Default/Productos";
...
declare namespace MDD.Default {
    class OrderDetailsEditor extends Serenity.Extensions.GridEditorBase<OrderDetailsRow> {
        protected getColumnsKey(): string;
...
declare namespace MDD.Default {
    class OrderDetailsEditDialog extends Serenity.Extensions.GridEditorDialog<OrderDetailsRow> {
        protected getFormKey(): string;
        protected getNameProperty(): string;
        protected getLocalTextPrefix(): string;
